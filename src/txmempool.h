...
public:
     ...
     */
    void RemoveStaged(setEntries &stage, bool updateDescendants, MemPoolRemovalReason reason = MemPoolRemovalReason::UNKNOWN, bool fRemoveFromDb = false) EXCLUSIVE_LOCKS_REQUIRED(cs);
